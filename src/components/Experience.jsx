...
function Experience() {
    ...
    return (
        <div className='w-[100%] h-[100vh] flex items-start flex-wrap justify-start'>
            ...
            <div className='p-[3%] w-1/3 h-[100%] bg-red-00 flex flex-wrap bg-red-00'>
                <div className='w-[100%] h-[50%] flex flex-wrap font-[clash_display] bg-blue-00 '>
                    ...
                    <div className='h-fit mt-3 p-3 text-[2.5vw] font-medium bg-red-00 rounded-3xl w-[100%] border-[2px] transition-all duration-200 hover:'>
                        Full Stack Development, Graphic Design, 2D art
                    </div>
                </div>
                <div className='w-[100%] h-[50%] bg-red-00 mt-5'>
                    <h1 className='text-[2.5vw] font-semibold font-[clash_display]'>Interests</h1>
                    <div className='w-full h-[80%] gap-2 flex justify-between'>
                        <div className='w-[50%] h-[100%]'>
                            <div className='h-[95%] min-w-1/2 p-3 text-[2.5vw] font-medium bg-[#3C3C3C] rounded-3xl border-[2px]'>
                            </div>
                        </div>
                        <div className='w-[50%] h-[100%] pb-[4%] gap-3 flex flex-col items-center justify-between'>
                            <div className='h-[50%] min-w-1/2 p-3 text-[2.5vw] font-medium bg-red-00 rounded-3xl  border-[2px]'>gasdfasd</div>
                            <div className='mt-2 h-[50%] min-w-1/2 p-3 text-[2.5vw] font-medium bg-red-00 rounded-3xl  border-[2px]'>gasdfasd</div>
                        </div>
                    </div>
                </div>
            </div>
