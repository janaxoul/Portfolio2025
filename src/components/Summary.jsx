        ...
        <div className="flex flex-wrap">
            <div className=' relative p-[3%] h-[50vh] text-[clash_display] w-[100%] flex items-start justify-start gap-10'>
                <div className='w-[35%] h-[100%] bg-blue-00'>
                    <div className=" relative w-[100%] h-[100%] rounded-3xl overflow-hidden">
                        <h4 className="absolute text-[3vw] p-5 font-[clash_display] text-[#f4f4f4]">Hello,</h4>
                        <div className="absolute bottom-0 w-[100%] p-5">
                        <h1 className="text-[#f4f4f4] font-[clash_display] text-end text-[2.5vw] leading-none whitespace-normal tracking-wide overflow-hidden">My name is </h1>
                        <h1 className="text-[#f4f4f4] font-[clash_display] text-end text-[4vw] leading-none whitespace-normal tracking-wide overflow-hidden">Janarthanan</h1>
                        </div>
                        <img src="https://cdn.pixabay.com/photo/2019/09/01/10/13/portrait-4444764_1280.jpg" alt="" />
                    </div>
                </div>
            ...
            <div className="relative p-[3%] h-fit text-[clash_display] w-[100%] flex flex-wrap items-center justify-between gap-10">
                <div className="px-[2vw] py-[2vw] w-[100%] text-2xl font-[clash_display] gap-2 flex flex-col tracking-wide border-[2px] rounded-3xl">
                    <h1 className="font-[600]">Tech-stack</h1>
                    <div className="flex flex-wrap gap-2">
                    {techSkills.map((item, index)=><RoundedText key={index} data={item}/>)}
                    </div>
                </div>
                <div className="px-[2vw] py-[2vw] w-1/3 text-2xl font-[clash_display] gap-2 flex flex-col tracking-wide border-[2px] rounded-3xl">
                ...
                <div className="w-1/3 w px-[2vw] py-[2vw] text-2xl font-[clash_display] gap-2 flex flex-col tracking-wide border-[2px] rounded-3xl">
